<head>
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{ asset('vendors/bower_components/morris.js/morris.css') }}">
    <!-- jvectormap -->
    ...
    <link rel="stylesheet" href="{{ asset('vendors/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}">
    <!-- DataTables -->
    ...
    <!-- Toastr bootstrap -->
    <link rel="stylesheet" href="{{ asset('vendors/plugins/toastr/build/toastr.min.css')}}">
    <!-- fileinput -->
    <link rel="stylesheet" href="{{ asset('vendors/plugins/bootstrap-fileinput/css/fileinput.min.css')}}">
    <!-- nestable -->
    <link rel="stylesheet" href="{{ asset('vendors/plugins/nestable/nestable.css')}}">

    <!-- Icon picker -->
    <link rel="stylesheet" href="{{ asset('vendors/plugins/fontawesome-iconpicker/dist/css/fontawesome-iconpicker.min.css') }}">
