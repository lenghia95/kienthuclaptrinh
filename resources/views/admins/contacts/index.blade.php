                    ...
                    <table id="example" class="table table-hover table-striped table-bordered">
                        ...
                        @foreach($contacts as $contact)
                            <tr>
                                ...
                                <td align="center">
                                    <a href="{{ route('contacts.show',[ 'id' => $contact->id ]) }}"><i class="fa fa-eye"></i></a>
                                    <a href="javascript:void(0);" data-id="{{ $contact->id }}" class="grid-row-delete"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
            ...
            $('.grid-row-delete').unbind('click').click(function() {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            method: 'POST',
                            url: "{{ url('/admin/ajax/contact_del')  }}/"+ id,
                            data: {
                                _method: 'DELETE',
                                _token: "{{ csrf_token() }}",
                            },
